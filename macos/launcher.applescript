on run
	...
	set chosenAction to choose from list {"起動", "初回セットアップ", "更新", "ローカル文字起こしを追加", "READMEを開く"} with prompt "やりたい操作を選んでください" default items {"起動"}
	...
	else if actionName is "READMEを開く" then
		set actionArg to "help"
	end if
